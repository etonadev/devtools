...
export function HomePage() {
  return <main className="home-page">
    <Seo title={seoMetadata.pages.home.title} description={seoMetadata.pages.home.description} path={seoMetadata.pages.home.path} />
